...
+ [Что такое _«пирамида тестирования»_?](#Что-такое-_пирамида-тестирования_?)
+ [Что такое _«модульное тестирование»_?](#Что-такое-_модульное-тестирование_?)
...
+ [Что такое _«интеграционное тестирование»_?](#Что-такое-_интеграционное-тестирование_?)
...
+ [Чем _stub_ отличается от _mock_?](#Чем-_stub_-отличается-от-_mock_?)
+ [Что такое _«фикстуры»_?](#Что-такое-_фикстуры_?)
