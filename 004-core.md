...
+ [Зачем нужен модификатор `strtictfp`?](#зачем-нужен-модификатор-strtictfp)
...
| `short` | 32 бита       | 0                | -2<sup>31</sup> | 2<sup>31</sup>-1 |
| `long`  | 64 бита       | 0l               | -2<sup>63</sup> | 2<sup>63</sup>-1 |

+ __Числа с плавающей запятой__
...
## Зачем нужен модификатор `strtictfp`?
