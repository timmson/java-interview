...
# Java Core
+ [Какие существуют модификаторы доступа?{#id1}](#Какие-существуют-модификаторы-доступа?id1)
...
+ [Дайте определение понятию _«интерфейс»_. Какие модификаторы по умолчанию имеют поля и методы интерфейсов?](#Дайте-определение-понятию-_интерфейс_-Какие-модификаторы-по-умолчанию-имеют-поля-и-методы-интерфейсов?)
...
+ [Что имеет более высокий уровень абстракции - _класс_, _абстрактный класс_ или _интерфейс_?](#Что-имеет-более-высокий-уровень-абстракции---_класс_,-_абстрактный-класс_-или-_интерфейс_?)
...
+ [Что такое _«статический класс»_?](#Что-такое-_статический-класс_?)
...
+ [Что такое _«локальный класс»_? Каковы его особенности?](#Что-такое-_локальный-класс_?-Каковы-его-особенности?)
+ [Что такое _«анонимные классы»_? Где они применяются?](#Что-такое-_анонимные-классы_?-Где-они-применяются?)
...
+ [Что такое _autoboxing («автоупаковка»)_ в Java и каковы правила упаковки примитивных типов в классы-обертки?](#Что-такое-_autoboxing-автоупаковка_-в-Java-и-каковы-правила-упаковки-примитивных-типов-в-классы-обертки?)
...
+ [Что такое _«конструктор по умолчанию»_?](#Что-такое-_конструктор-по-умолчанию_?)
...
+ [Что такое _checked_ и _unchecked exception_?](#Что-такое-_checked_-и-_unchecked-exception_?)
...
+ [Какие существуют _unchecked exception_?](#Какие-существуют-_unchecked-exception_?)
...
+ [Может ли метод _main()_ выбросить исключение во вне и если да, то где будет происходить обработка данного исключения?](#Может-ли-метод-_main_-выбросить-исключение-во-вне-и-если-да,-то-где-будет-происходить-обработка-данного-исключения?)
...
+ [Что такое _«интернационализация»_, _«локализация»_?](#Что-такое-_интернационализация_,-_локализация_?)

## Какие существуют модификаторы доступа?{#id1}
